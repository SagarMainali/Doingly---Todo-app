...
function Todo() {
     return (
          <div className='flex p-2 gap-5 items-start'>
               <input type="checkbox" name='completed' className="cursor-pointer mt-2" />
               <textarea className='w-full resize-none bg-transparent scrollbar-hide focus:outline-0 focus:border-b-2 border-bluey' defaultValue='Complete my todo project by tomorrow anyhow' rows={2}/>
