...
function Todo() {
     return (
          <div className='flex py-4 gap-10 px-2 items-center'>
               <input type="checkbox" name='completed' className="cursor-pointer" />
               <input className='w-full bg-transparent focus:outline-0 focus:border-b-2 border-bluey' type="text" defaultValue='Complete my todo project by tomorrow anyhow' />
               <div className="tools flex flex-wrap justify-end gap-x-4 gap-y-2">
                    ...
                    <span className='w-full text-end text-greyy'>18th April, 2023</span>
               </div>
