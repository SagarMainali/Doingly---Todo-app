...
function Todo() {
     return (
          <div className='flex p-2 gap-5 items-center'>
               ...
               <textarea className='w-full h-8 py-1 resize-none bg-slate-200 scrollbar-hide focus:outline-0 focus:border-b-2 border-bluey' defaultValue='Complete my todo project by tomorrow anyhow'/>
