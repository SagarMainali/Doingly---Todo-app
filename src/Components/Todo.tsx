...
function Todo({ item }: { item: TodoObj }) {
     ...
     useEffect(() => {
          (editMode && todoInput.current) && todoInput.current.focus()
     }, [editMode])
